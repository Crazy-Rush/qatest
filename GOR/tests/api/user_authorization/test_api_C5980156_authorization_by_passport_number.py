import allure
from test_framework.ui.data.user_data import valid_passport_number_universal, valid_password
...
def test_api_c5980156_authorization_by_passport_number(authorization_by_passport) -> None:
    ...
    authorization_by_passport(passport_number=valid_passport_number_universal, password=valid_password)
