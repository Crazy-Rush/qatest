...
@pytest.mark.ui
@allure.id("C6032438")
@allure.title("C6032438. Возможность для пользователя просматривать реквизиты карты 'GoR Gold'")
def test_ui_c60322438_user_can_view_card_gold_details(open_browser):
    ...
    # Кликнуть на изображение карты 'GoR Gold'
