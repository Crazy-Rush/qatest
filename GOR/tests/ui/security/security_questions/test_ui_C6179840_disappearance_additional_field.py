...
@pytest.mark.ui
@allure.id("C6179840")
@allure.title('C6179840. Исчезновение дополнительного поля "Напишите ваш контрольный вопрос"')
def test_ui_C6179840_disappearance_additional_field(open_browser):
    ...
    # Проверка отсутвия элемента "Напиши ваш контрольный вопрос"
    ProfileSecurityPage(open_browser).check_not_displaying_elements_put_your_question()
