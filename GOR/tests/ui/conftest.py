...
def open_browser(request):
    ...
    try:
        ...
        StepsUserService().delete_fingerprint_from_table_by_id_client(valid_client_id_ui_python)
        browser.quit()
...
def browser_change_password_after_test(request):
    ...
    try:
        ...
        profile_security_page.enter_new_password(valid_password)
        profile_security_page.enter_confirm_new_password(valid_password)
