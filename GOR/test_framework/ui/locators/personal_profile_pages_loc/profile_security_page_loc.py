...
class LocatorsProfileSecurityPage:
    ...
    field_current_password_locator = (By.XPATH, "//input[@name='currentPassword']")
    field_create_new_password_locator = (By.XPATH, "//input[@name='newPassword']")
    field_confirm_new_password_locator = (By.XPATH, "//input[@name='confirmNewPassword']")
