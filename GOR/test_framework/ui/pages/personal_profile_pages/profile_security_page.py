...
import allure
from test_data.ui.url_data import PROFILE_SECURITY_PAGE
...
class ProfileSecurityPage(BasePage):
    def __init__(self, browser, url=None) -> None:
        ...
        self.locators_by = LocatorsProfileSecurityPage
        self.error = DataMessages
        self.data = DataProfilePage
        self.url = PROFILE_SECURITY_PAGE
